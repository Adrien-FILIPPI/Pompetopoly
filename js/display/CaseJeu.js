...
function Test(titre, axe, pos, type, message, img) {
    PlateauCase.call(this,axe,pos,type);
    this.message = message;
    this.drawing = DrawerFactory.getCase(pos, axe, null, titre, "", img);
	Drawer.add(this.drawing);
	this.action = function () {
		return InfoMessage.create(GestionJoueur.getJoueurCourant(),titre, "lightblue", message);
	}
}
